<?php
//Archive file for NON-SHORTCODE archiving
//Get contents of header.php
get_header();
...
if (have_posts()) { ?>
	<?php if ($title_string == "Act 1" || $title_string == "Chapter 1") : ?>
		<img class="archive_act_img" src="<?php echo home_url(); ?>/wp-content/uploads/Act1.png"/>
	<?php elseif ($title_string == "Act 2" ||  $title_string == "Chapter 13") : ?>
		<img class="archive_act_img" src="<?php echo home_url(); ?>/wp-content/uploads/Act2.png"/>
	<?php endif; ?>
